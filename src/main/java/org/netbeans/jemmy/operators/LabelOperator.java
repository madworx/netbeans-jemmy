 ...
 *
 * $Id: LabelOperator.java,v 1.6 2006/06/30 14:00:47 jtulach Exp $ $Revision: 1.6 $ $Date: 2006/06/30 14:00:47 $
 *
 */
...
public class LabelOperator extends ComponentOperator {
	...
	public LabelFinder(ComponentChooser sf) {
            super(Java5Compat.init(Label.class), sf);
	}
        /**
         * Constructs LabelFinder.
         */
	public LabelFinder() {
            super(Java5Compat.init(Label.class));
	}
    }
}
