 ...
 *
 * $Id: JListOperator.java,v 1.15 2006/06/30 14:00:45 jtulach Exp $ $Revision: 1.15 $ $Date: 2006/06/30 14:00:45 $
 *
 */
...
public class JListOperator extends JComponentOperator
	...
	public JListFinder(ComponentChooser sf) {
            super(Java5Compat.init(JList.class), sf);
	}
        /**
         * Constructs JListFinder.
         */
	public JListFinder() {
            super(Java5Compat.init(JList.class));
	}
    }
}
